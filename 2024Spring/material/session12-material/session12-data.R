...
fwrite(education_data, here("2024Spring/material/session12-material/education_income.csv"))
...
fwrite(education_data, here("2024Spring/material/session12-material/child_mortality.csv"))
